...
if (list.at(0) == "album")
{
   AlbumView *ab = CollectionManager::getInstance()->getServiceCollection(list.at(2))->getAlbumFromId(list.at(1));
   retour =  CollectionManager::getInstance()->getServiceCollection(list.at(2))->getJacketFromAlbum(ab);
}
else if (list.at(0) == "artist")
{
   ArtistView *a = CollectionManager::getInstance()->getServiceCollection(list.at(2))->getArtistFromId(list.at(1));
